...
- (void)loadImageTexts
{
    ...
    [PTImageTextHelper addImage:@"1.png" aspectRatio:0.628333 toArray:_imageTexts];
    ...
    [PTImageTextHelper addImage:@"2.png" aspectRatio:0.666667 toArray:_imageTexts];
    ...
    [PTImageTextHelper addImage:@"3.png" aspectRatio:1.333333 toArray:_imageTexts];
    [PTImageTextHelper addText:@"明洞天主教堂是《原来是美男啊》的拍摄地，很有感觉！" userName:@"叫我兰哥" toArray:_imageTexts];
    [PTImageTextHelper addImage:@"4.png" aspectRatio:0.67 toArray:_imageTexts];
